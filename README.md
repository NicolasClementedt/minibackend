...
Esta API funciona como o backend de um mini e-commerce, fornecendo dados de produtos de forma simples e eficiente.  
O objetivo do projeto é demonstrar a construção de uma API REST organizada, seguindo boas práticas de arquitetura com NestJS.
